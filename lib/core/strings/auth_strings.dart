class AuthStrings {
  ...
  static const String loginWithEmail = 'تسجيل الدخول بالبريد الإلكتروني';
  static const String loginWithGoogle = 'تسجيل الدخول بجوجل';
  static const String continueAsGuest = 'الدخول كزائر';

  // Email Auth
  static const String emailAuthTitle = 'تسجيل الدخول';
  static const String emailAuthSubtitle = 'أدخل بريدك الإلكتروني وكلمة المرور';
  ...
  static const String signUpSubtitle = 'انضم إلينا الآن';
